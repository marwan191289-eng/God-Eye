        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-sm flex items-center gap-2">
              REINFORCE محلي — محاكاة تعليمية
              {active && (
                <>
                  <span className="text-[9px] mono px-1.5 py-0.5 rounded-full bg-gold/20 text-gold border border-gold/30 uppercase tracking-wider">تجريبي</span>
                  {dispStep > 0 && (
                    <span className="text-[9px] mono px-1.5 py-0.5 rounded-full bg-primary/20 text-primary border border-primary/30 uppercase tracking-wider flex items-center gap-0.5">
            ...
            <div className="text-[10px] text-muted-foreground">
              {active
                ? thinking
                  ? "جاري التحليل..."
                  : `تيكر #${tickR.current} · خطوات: ${dispStep} · ε=${(dispExpl*100).toFixed(0)}% · يبدأ من صفر في كل جلسة`
                : "يعمل محليًا في المتصفح · يبدأ من صفر في كل جلسة · ليس نموذجًا مُدرَّبًا مسبقًا"
              }
            </div>
          </div>
        </div>
